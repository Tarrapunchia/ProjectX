...
const Users = async (fastify, opts) => {
    ...
    fastify.get('/:id/profile', { schema: userSchemas.getUserProfile }, // se vuoi validare anche i campi extra, serve uno schema nuovo
    async (req, reply) => {
    ...
    fastify.post('/addUser', { schema: userSchemas.createUser }, async (req, res) => {
        const { name, surname, email, phone, jobQualifier, password, passwordRepeat, city, address, cap, state, } = req.body;
        // validazione (minima)
