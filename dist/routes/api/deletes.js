...
const Delete = async (fastify) => {
    fastify.delete('/files/:organizationId/:filename', async (request, reply) => {
        const { organizationId, filename } = request.params;
        ...
        if (organizationId) {
            ...
            if ((permission === null || permission === void 0 ? void 0 : permission.userId) !== (org === null || org === void 0 ? void 0 : org.ownerId)) {
                reply.code(403);
    ...
    fastify.delete('/files/:organizationId/:projectId/:filename', async (request, reply) => {
        const { organizationId, projectId, filename } = request.params;
