export default function renderRegistration() {
  ...
  <title>Registration — FT_TRANSCENDENCE</title>
    ...
    <section class="card-neon w-full max-w-md relative overflow-hidden">
      ...
      <div class="relative z-10">
        ...
        <form class="mt-8 space-y-4" action="#" method="post">
          <div>
            <label class="block text-xs uppercase tracking-widest text-white/60 mb-1">Username</label>
        ...
        <div>
            <label class="block text-xs uppercase tracking-widest text-white/60 mb-1">Repeat Password</label>
            <input class="input-neon" type="password" name="password" placeholder="••••••••" />
          </div>

        <div class="mb-2">
        <label class="block text-xs uppercase tracking-widest text-white/60 mb-1">Profile Image</label>

        <!-- box anteprima -->
        <div class="relative w-28 h-28 rounded-full overflow-hidden ring-2 ring-[#ff00ffaa] shadow-[0_0_30px_#ff00ff66]">
            <img id="profile-preview" src="https://picsum.photos/200" alt="Preview"
        ...
        <!-- upload da file -->
        <div>
        <label class="block text-xs uppercase tracking-widest text-white/60 mb-1">Upload an Image</label>
        <input id="profile-file" class="input-neon" type="file" name="profileImage" accept="image/*">
        </div>
