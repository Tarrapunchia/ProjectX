export default function renderPrivateProfile() {
    return `
    <head>
    <meta charset="utf-8" />
    ...
    <main class="mx-auto max-w-6xl px-4 pt-8 pb-16 items-center justify-center">
        ...
        <div class="relative z-10 p-6 md:p-10 flex flex-col md:flex-row items-center gap-6 md:gap-10">
            ...
            <div class="mt-4 flex items-center justify-center md:justify-start gap-3">
                <button class="btn-neon text-xs">Change Infos</button>
            </div>
            </div>
        </div>
        </section>
        ...
        <!-- Friends (placeholder, 10 per pagina) -->
        <section class="mt-10 rounded-2xl border border-white/10 bg-black/40 overflow-hidden">
        <header class="flex items-center justify-between px-4 md:px-6 py-4 border-b border-white/10">
            <h2 class="uppercase tracking-[0.25em] text-sm text-white/80">Friends</h2>

            <!-- controls -->
            <div class="flex items-center gap-3 text-xs">
            <span id="friends-range" class="text-white/60">1–12 of 42</span>
            <div class="flex items-center gap-2">
                <button id="friends-prev"
                        class="h-8 px-3 rounded-md border border-white/15 text-white/80 hover:bg-white/10 disabled:opacity-40 disabled:hover:bg-transparent">
                Prev
                </button>
                <button id="friends-next"
                        class="h-8 px-3 rounded-md border border-white/15 text-white/80 hover:bg-white/10 disabled:opacity-40 disabled:hover:bg-transparent">
                Next
                </button>
            </div>
        ...
        <!-- griglia -->
        <div id="friends-grid" class="grid grid-cols-[repeat(auto-fit,minmax(220px,1fr))] gap-4 p-4 md:p-6">
        <!-- popolata via TS per ora in maniera fittizia, poi si fa con DB -->
        </div>
        </section>
