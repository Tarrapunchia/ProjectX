...
const STEPS = [
  ...
  { id: "city", label: "City", placeholder: "e.g. London, UK", type: "text" },
  { id: "address", label: "Residential Address", placeholder: "e.g. 123 Baker St", type: "text" },
  { id: "bio", label: "Professional Summary", placeholder: "Share your expertise, key skills, or a brief introduction...", type: "textarea" },
];

export default function ProfileCompletionModal({ isOpen, onClose, onSave }: Props) {
  const [shouldRender, setShouldRender] = useState(false);
  const [isExiting, setIsExiting] = useState(false);
  const [currentStep, setCurrentStep] = useState(0); // Gestisce lo step attuale
