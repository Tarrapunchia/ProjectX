		...
		return (
			<div className="relative flex h-full w-full items-center justify-center text-zinc-500">
				...
				<p className="text-center">
					There are no files to display for this project.
				</p>
			</div>
		);
    ...
    return (
        <div className="w-full h-full">
            ...
            <div className="w-full">
                ...
                <div className="grid grid-cols-12 gap-4 px-4 py-2 text-xs font-bold uppercase text-zinc-500 border-b border-overlay-border-color">
                    <div className="col-span-6">File Name</div>
					<div className="col-span-2">Created By</div>
                    <div className="col-span-1 text-center">Date Created</div>
					<div className="col-span-1 text-center">Last Date Modified</div>
                    <div className="col-span-1 text-center">Extension</div>
                ...
                <div className="flex flex-col">
                    {files.map((file) => (
                        <div
                            ...
                            className="grid grid-cols-12 gap-4 px-4 py-4 items-center border-b border-overlay-border-color/50 
                                     hover:bg-side-bg-color cursor-pointer transition-colors group"
                        >
                            {/* NOME E ICONA */}
							...
							{/* DATA DI CREAZIONE */}
                            <div className="col-span-2 text-left text-sm text-zinc-500">
                                {file.createdAt || "Osme"}
                            </div>

                            <div className="col-span-1 text-center text-sm text-zinc-500">
                                {file.createdAt || "May 10, 2026"}
                            </div>

							<div className="col-span-1 text-center text-sm text-zinc-500">
                                {file.createdAt || "May 11, 2026"}
                            </div>

                            {/* ESTENSIONE (TIPO) */}
                            <div className="col-span-1 text-center">
                                <span className="text-[10px] px-2 py-1 bg-overlay-border-color text-text-main rounded uppercase font-bold">
                                    {file.type}
                                </span>
                            </div>
            ...
            {/* IL MODAL DI ANTEPRIMA RIMANE LO STESSO (OMESSO PER BREVITÀ) */}
            {preview && (
