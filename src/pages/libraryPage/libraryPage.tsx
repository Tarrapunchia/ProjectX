            ...
            <div className="flex flex-col">
                {files.map((file) => (
                    <div
						...
						className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4 px-4 py-4 border-b 
						border-overlay-border-color/50 hover:bg-side-bg-color cursor-pointer transition-colors">
                        {/* NOME E ICONA */}
        ...
        return (
            <div className="relative flex h-full w-full items-center justify-center text-zinc-500">
                ...
                <div className="absolute top-0 left-0 w-full flex justify-between items-center p-4">
                    <h1 className="hidden md:block text-xs font-bold text-text-main">Project Files</h1>
                    {isOwner && (
                        <div>
                            <input 
                                type="file" 
