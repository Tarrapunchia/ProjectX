...
export default function PriorityChart({ taskData }: { taskData: TaskInfos | null }) {
  // Gestione isMobile pulita per il grafico
  ...
  // --- LOGICA GRAFICO MEMOIZZATA (Per la velocità) ---
  ...
  return (
    // Torniamo alla tua griglia orizzontale originale [1.2fr_1fr]
    <div className="h-full relative p-4 grid grid-cols-[1.2fr_1fr] gap-4 max-h-full text-text-main overflow-hidden">
        ...
        {/* SEZIONE LISTA TASK (Tornata identica alla tua) */}
            ...
            {filteredTasks.map((task, index) => {
                ...
                return (
                    ...
                    >
                        ...
                        {/* Il tuo Tooltip originale con logica index */}
                        <div className={`
