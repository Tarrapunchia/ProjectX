export default function Notification() 
{
	function renderNotification(color: string, message: string, time: string) {
		return (
			<div className="flex items-start gap-3 p-3 rounded-lg cursor-pointer transition-colors shadow-sm border border-overlay-border-color hover:border-white shrink-0">
	...
	return (
		...
		<div className="flex flex-col h-full overflow-hidden">
			<h2 className="text-lg text-text-main font-semibold mb-4 flex justify-center shrink-0">
				Notifiche
			</h2>
