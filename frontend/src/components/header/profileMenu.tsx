...
export const ProfileMenu = ({ setActivePage, setProfileMenuOpen }: ProfileMenuProps) => {
    ...
    return (
		...
		>
			<div
				...
				className="absolute w-80 h-80 z-50 right-0 top-14 no-scrollbar bg-side-bg-color border border-owner-color rounded-md text-text-main "
			>
