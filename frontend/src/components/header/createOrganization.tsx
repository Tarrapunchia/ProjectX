            ...
            >
                ...
                >
                    <div className="flex flex-col">
                        <div className="text-2xl">{t('create_organization.p_iva')}</div>
                        <input
                            name="id"
                        ...
                        />
                        {isDuplicate && (
                            <span className="text-red-500 pl-1 pt-1 text-sm">{t('create_organization.error_duplicate')}</span>
                        )}
                    </div>

                    <div className="flex flex-col">
                        <div className="text-2xl">
                            {t('create_organization.name')}
                        </div>
                        <input
                            name="name"
                    ...
                    <div className="flex flex-col">
                        ...
                        />
                        {emailFormat && (
                            <span className="text-red-500 pl-1 pt-1 text-sm">{t('create_organization.error_email')}</span>
                        )}
                    </div>

                    <div className="flex flex-col">
                        <div className="text-2xl">
                            {t('create_organization.phone')}
                        </div>
                        <input
                            name="phone"
