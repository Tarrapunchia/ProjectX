                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                            <span className="text-xs font-semibold text-text-main leading-tight">
                                {group ? `${group.name}` : t('chat_window_group.fallback_group_name')}
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    >
                        {currentMessages.length > 0 ? (
                            ...
                            <div className="flex flex-col items-center justify-center h-full opacity-20 text-center">
                                ...
                                <p className="text-xs italic">{t('chat_window_group.start_conversation')}</p>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="p-3 bg-side-bg-color border-t border-overlay-border-color shrink-0">
                        <div className="relative flex items-center">
                            <input
                                ref={inputRef}
                                type="text"
                                placeholder={t('chat_window_group.type_message')}
                                value={inputText}
