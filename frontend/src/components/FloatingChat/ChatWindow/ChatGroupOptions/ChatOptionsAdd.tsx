		...
		>
            ...
            <div className="px-2 pt-2 bg-bg-color shrink-0">
                <div className="relative flex items-center">
                    ...
                    <input
                        type="text"
                        placeholder={t('chat_options_add.search_friends')}
                        value={searchQuery}
			...
			<div className="flex-1 min-h-0 overflow-y-auto no-scrollbar">
				{filteredFriends.length > 0 ? (
                        ...
                        >
                            ...
                            <div className="flex flex-col flex-1">
                                ...
                                <span className="text-[10px] opacity-60">
                                    {friend.isLoggedIn ? t('chat_options_add.online') : t('chat_options_add.offline')}
                                </span>
                            </div>
                        </div>
                    ))
                    ...
                    <div className="h-full flex flex-col items-center py-35 opacity-80">
                        ...
                        <p className="text-sm italic">{t('chat_options_add.no_friends_found')}</p>
                    </div>
                )}
            </div>
        </div>
