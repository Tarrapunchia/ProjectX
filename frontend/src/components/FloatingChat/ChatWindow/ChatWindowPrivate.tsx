                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                            <span className="text-xs font-semibold text-text-main leading-tight">
                                {friend ? `${friend.name} ${friend.surname}` : t('chat_window_private.fallback_user')}
                            </span>
                            <span className="text-[10px] opacity-50">
                                {friend?.isLoggedIn ? t('chat_window_private.online') : t('chat_window_private.offline')}
                            </span>
                        </div>
                    </div>
                </div>
            ...
            >
                {currentMessages.length > 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-full opacity-20 text-center">
                        ...
                        <p className="text-xs italic">{t('chat_window_private.start_conversation')}</p>
                    </div>
                )}
            </div>
            ...
            <div className='p-3 bg-side-bg-color border-t border-overlay-border-color shrink-0'>
                <div className="relative flex items-center">
                    <input
                        ref={inputRef}
                        type="text"
                        placeholder={t('chat_window_private.type_message')}
                        value={inputText}
