            ...
            prev.map(item =>
                item.project.id === projectId
                    ? {
                        ...
                        project: {
                            ...item.project,
                            tasks: item.project.tasks.map((t: any) =>
