        ...
        >
            ...
            >
                <div className="flex-none flex items-center justify-center text-3xl pt-8 pb-12 px-12 line-clamp-2">
                    {t('create_project.title', { name: activeOrg?.name || '' })}
                </div>
                ...
                >
                    <div className="flex flex-col pl-[10%]">
                        <div className="text-2xl">{t('create_project.name')}</div>
                        <input
                            name="name"
                    ...
                    <div className="flex flex-col w-full items-center">
                        <div className="text-2xl">{t('create_project.description')}</div>
                        <textarea
                            name="description"
                    ...
                    <div className="flex flex-row flex-wrap justify-center items-center space-x-[20%] w-full">
                        <div className="flex flex-col pb-10">
                            <div className="text-2xl">{t('create_project.deadline')}</div>
                            <input
                                type="date"
                                name="closedAt"
                        ...
                        <div className="flex flex-col border border-overlay-border-color rounded-sm h-60 w-100">
                            ...
                            >
                                <FiPlusCircle className="mr-2" size={24}/>{t('create_project.add_members')}
                            </button>
                            {addMemberOpen ? (
                                ...
                                <div className="flex flex-col text-lg">
                                    ...
                                    <div className="flex flex-col items-center justify-center gap-2 w-full h-full font-light">
                                        ...
                                        {t('create_project.no_participants')}
                                    </div>
                                )
                            )}
                        </div>
